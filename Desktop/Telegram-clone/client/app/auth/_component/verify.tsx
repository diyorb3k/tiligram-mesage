...
const Verify = () => {
  ...
  return (
    <div className="w-full">
      ...
      We have sent you an email with a verifacation code to your email address.Please enter tke code below
      </p>
      <Form {...form}>
      ...
      <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <Label>Email</Label>
                <FormControl>
                  <Input type="email" placeholder="Email" disabled className="h-10 bg-secondary" {...field}  />
                </FormControl>
